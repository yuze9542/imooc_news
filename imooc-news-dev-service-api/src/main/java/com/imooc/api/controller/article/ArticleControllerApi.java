...
@Api(value = "文章业务的Controller")
@RequestMapping("article")
public interface ArticleControllerApi {

    @ApiOperation(value = "上传",httpMethod = "POST")
    @PostMapping("createArticle")
    public GraceJSONResult createArticle(@RequestBody @Valid NewArticleBO bo,
                                         BindingResult result);

    @ApiOperation(value = "查询用户自己的文章列表",httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员对文章进行审核",httpMethod = "POST")
