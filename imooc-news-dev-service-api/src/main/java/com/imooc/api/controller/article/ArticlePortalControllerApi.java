...
public interface ArticlePortalControllerApi {
    ...
    @ApiOperation(value = "查询作者的文章", notes = "首页查询文章列表", httpMethod = "GET")
    ...
    @GetMapping("/detail")
    @ApiOperation(value = "文章详情查询", notes = "用户撤回文章", httpMethod = "GET")
    public GraceJSONResult detail(@RequestParam String articleId);


    @PostMapping("/readArticle")
    @ApiOperation(value = "文章阅读量列加", notes = "用户撤回文章", httpMethod = "POST" )
